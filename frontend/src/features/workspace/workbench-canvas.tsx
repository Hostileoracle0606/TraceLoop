  ...
  return (
    <section className={cn('workbench-partition simulation-partition', isBuilding && 'is-building')}>
      <header className="partition-header">
        ...
        <span className={cn('partition-runtime', isBuilding && 'is-building')}><i />{isBuilding ? `${buildProgress}% constructed` : 'Renode · live'}</span>
      </header>
  ...
  return (
    <section className="workbench-partition code-partition">
      <header className="code-authoring-header">
        ...
        <span className={cn('authoring-state', isAuthoring && 'is-active')}><i />{isAuthoring ? 'Agent editing' : 'Source ready'}</span>
      </header>
