    ...
    <div className="app-shell">
      ...
      <div className="app-main">
        <header className="global-topbar">
          ...
          <div className="project-context"><span><small>Project</small><strong>Timer LED Controller</strong></span><span /><span><small>Board</small><strong>STM32F4 Discovery</strong></span><span /><span><small>Branch</small><strong>ⵂ agent/timer2-led</strong></span></div>
